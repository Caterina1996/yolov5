...
path_to_calls = r"/home/antonio/yolov5/projects/fish/17_species"
path_to_project = r"/home/antonio/yolov5/projects/fish/17_species"
path_to_dataset = r"/home/antonio/yolov5/datasets/fish/17_species"
dataset_yaml = r"/home/antonio/yolov5/data/fish_17_species.yaml"
        ...
        for i in range(1, k+1):
            ...
            for model_size in model_sizes.keys():
                ...
                for lr in lrs:
                    ...
                    instruction=f"python ../segment/train.py --img 1280 --batch 8 --epochs 400 --data {dataset_yaml} --weights yolov5{model_size}-seg.pt --patience 0 \
                    --project {project_name} --name {run_name} --seed 42 --device 0 --optimizer 'SGD'"
