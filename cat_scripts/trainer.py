...
training_instruction="python train.py --img 1024 --batch 8 --epochs 200 --data halimeda_temp.yaml --weights yolov5x.pt --patience 50 \
...
inference_instruction="python detect.py --weights /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/weights/best.pt \
                    ...
                    --source  /mnt/c/Users/haddo/yolov5/datasets/halimeda/kfold/images/test/  --save-txt --save-conf --conf-thres 0.01 --line-thickness 1"
...
inference_instruction_SS="python detect.py --weights /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/weights/best.pt \
                    --project /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/  --name inference_SS/ --data data/halimeda_temp.yaml \
...
pascalvoc_instruction="python /mnt/c/Users/haddo/object_detection_utils/metrics/pascalvoc.py \
                    ...
                    -gt /mnt/c/Users/haddo/yolov5/datasets/halimeda/kfold/labels/test -det /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/inference_test/labels/ \
...
coverage_instruction="python /mnt/c/Users/haddo/object_detection_utils/metrics/coverage.py --shape 1024 \
                    ...
                    --path_out /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/inference_test/coverage/ --grid 10 "
...
eval_ss2_instruction="python /mnt/c/Users/haddo/object_detection_utils/metrics/eval_ss2.py \
                    ...
                    --run_name {} --save_path /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/inference_test --shape 1024"
...
# inference_instruction_SS="python detect.py --weights /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/weights/best.pt \
#                     --project /mnt/c/Users/haddo/yolov5/projects/halimeda/NEW_DATASET/{}/  --name inference_SS_trainval/ --data data/halimeda_temp.yaml \
