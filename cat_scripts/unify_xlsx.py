...
python unify_xlsx.py --path_in projects/halimeda/NEW_DATASET/ --path_out projects/halimeda/NEW_DATASET/  --lookfor "metrics.xlsx"

python unify_xlsx.py --path_in projects/halimeda/NEW_DATASET/low9_da --path_out  projects/halimeda/NEW_DATASET/low9_da  --lookfor "metrics.xlsx"
...
def main():
    ...
    filepath = os.path.join(path_out,"metrics_yolo_low_da_testfolds_thr81.xlsx")
